 ...
 * @author Miguel
 */
public class JFrameAlqFURGO extends javax.swing.JFrame {
...
//         arr2=  a.leerArchivo(file);
    ...
    ArrayList <furgoneta> Coches = new  ArrayList <furgoneta>();
            
              //************************************************
              for (int i = 0; i < arr2.size(); i++) {
                   if(arr2.get(i) instanceof furgoneta){
                       Coches.add((furgoneta) arr2.get(i));
                   }
            }
              int k=0;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(300, 10, 290, 32);
        ...
        jLabel3.setText("ALQUILAR VEHÍCULO [FURONETA]");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 11, 280, 32);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameAlqFURGO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameAlqFURGO().setVisible(true);
            }
        });
    }
