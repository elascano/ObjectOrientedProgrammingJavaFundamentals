 ...
 */
public class Operaciones2 extends OperacionesPadre {
    ...
    OperacionesPadre operacionesPadre;

    public void sumar() {
        Operaciones2 op;

        //System.out.println("aja -> " + op.a); // error por no estar inicializado
        operacionesPadre.getClass(); // es un objeto del objeto, entonces si funciona. no hace falta inicializar.
    }
    ...
    public static void main(String[] args) {
        ...
        if (animal != null && animal == null & animal.ojos.equals("ooo")) {
