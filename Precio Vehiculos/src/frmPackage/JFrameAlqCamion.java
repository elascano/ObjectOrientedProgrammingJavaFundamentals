 ...
 * @author Miguel
 */
public class JFrameAlqCamion extends javax.swing.JFrame {
static String  file ="Coches.txt";
 static String C[]={"N°","Matricula","Modelo","Marca","Color","Kilometraje","Cilindrada"
         ,"Tipo de Combustión","Numero de Llantas","Tonelaje","Disponibilidad"};
 
// static String C[]={"N°","Matricula","Numero de Pasajeros","Modelo","Marca","Color","Kilometraje","Cilindrada"
//         ,"Tipo de Combustión","Tipo Vehiculo","Numero de Llantas","Tonelaje","Disponibilidad"};
...
//         arr2=  a.leerArchivo(file);
    ...
    ArrayList <Camion> Coches = new  ArrayList <Camion>();
            
              //************************************************
              for (int i = 0; i < arr2.size(); i++) {
                   if(arr2.get(i) instanceof Camion){
                       Coches.add((Camion) arr2.get(i));
                   }
            }
              int k=0;
              for (int i = 0; i < Coches.size(); i++) {
                if(Coches.get(i).isDisponibilidad()==true){
                     Object O[]={(k+1),Coches.get(i).getMatricula(),Coches.get(i).getModelo()
    ,Coches.get(i).getMarca(),Coches.get(i).getColor(),Coches.get(i).getKilometraje(),
    Coches.get(i).getCilindrada(),Coches.get(i).getCombustible(),Coches.get(i).getNumllantas(),Coches.get(i).getTonelaje(),"No Alquilado"};
      this.model.addRow(O);
      k++;
                }
            }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameAlqCamion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameAlqCamion().setVisible(true);
            }
        });
    }
